...
public class InterfaceMethodsImplimentation implements InterfaceMethods
{
    ...
    public void ResultFile()
    {
        ...
        System.out.println("How many Characters you Want in a Line: Enter number greater then 0");
        int n = sc.nextInt();
        if(n>0) {
            ...
            FileWriter MyWriter;
            try {
                MyWriter = new FileWriter("C:\\Users\\B Mahadev\\Desktop\\FileHandeling\\RandomStringClass.txt");
